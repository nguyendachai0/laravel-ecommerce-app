                    ...
                    <div class="coupon_code left" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <form action="{{ route('orders.store') }}" method="post">
                            ...
                            <div class="default-form-box">
                                ...
                                <input type="text" id="address1" name="address1" required class="input-field">
                            </div>
                            <div class="default-form-box">
                                <label for="address2">Address Line 2:</label>
                                <input type="text" id="address2" name="address2" class="input-field">
                            </div>
                            <div class="default-form-box">
                            ...
                            <div class="default-form-box">
                                ...
                                <input type="text" id="zipcode" name="zipcode" required class="input-field">
                            </div>
                            <div class="default-form-box">
                                <label for="country_code">Country Code:</label>
                                <input type="text" id="country_code" name="country_code" required class="input-field">
                            </div>
