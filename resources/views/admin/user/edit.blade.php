        ...
        <div class="bg-teal-200 p-8 rounded shadow-md">
            ...
            <form action="{{ url('admin/user/update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                    ...
                    <input type="text" name="name" id="name" value="{{$user->name}}" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500">
                </div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                 ...
                 <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                    ...
                    <select name="role_as" id="password" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500">
                        ...
                        <option {{($key == $user->role_as) ? 'selected' : ''}} value="{{$key}}">{{$value}}</option>
                        <?php endforeach;?>
